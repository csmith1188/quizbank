...
const CONFIG = {
    ...
    promptFileMaxBytes: intFromEnv('PROMPT_FILE_MAX_BYTES', 2 * 1024 * 1024),
    promptFilesTotalMaxBytes: intFromEnv('PROMPT_FILES_TOTAL_MAX_BYTES', 5 * 1024 * 1024),
    promptContextMaxWords: intFromEnv('PROMPT_CONTEXT_MAX_WORDS', 3000),
